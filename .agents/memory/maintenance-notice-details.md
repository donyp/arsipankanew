...
**How to apply:** Pertahankan format array objek `{ summary, description }` saat menyimpan `lastResult.details`, aktifkan scroll internal mulai item ketiga, gunakan notifikasi global untuk pusat notifikasi, dukung format teks lama saat membaca, dan escape seluruh teks sebelum dirender ke HTML.